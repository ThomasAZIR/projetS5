...
<div class="humberger__menu__wrapper">
    ...
    <div class="humberger__menu__widget">
        ...
        <div class="header__top__right__auth">
            <a href="#"><i class="fa fa-user"></i><?php echo $statut;?> </a>
        </div>
    </div>
...
<section class="Inscription">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 text-center">
                <div class="contact__widget">
                    <form id="formConnexion" onsubmit="return valider();" name="Formu" method="post"
                          action="inscrire.php">
                        <table>
                            </td></tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ide" placeholder="Saissez votre identifiant" size="18"
                        ...
                        <br>
                        <div><input type="submit" value="Connexion" name="btn"> <input type="reset" value="Effacer"/></div>
                    </form>
                </div>
            </div>
        </div>
